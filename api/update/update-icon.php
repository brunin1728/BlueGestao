...
// ADICIONAR NO BANCO DE DADOS //
	...
	$validate &= ! empty( $ID );
	  ...
	  $VALOR1 = "TITULO_DESTAQUE_".$S."A";
	  $VALOR2 = "TEXTO_DESTAQUE_".$S."A";
	  $VALOR3 = "IMAGEM_DESTAQUE_".$S."A";
	...
	if ( $validate ) {
		$stmt = $conn->prepare
		("UPDATE tbl_destaque_cont SET ".$VALOR1." = '".$TITULO."', ".$VALOR2." = '".$TEXTO."' WHERE ID_DESTAQUE = '".$ID."'");
